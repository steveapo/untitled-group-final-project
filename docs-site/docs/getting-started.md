...
- **[📦 Download for macOS/Linux](https://github.com/steveapo/untitled-group-final-project/releases/download/v1.6.2/HotelBooking-v1.6.2.tar.gz)**
- **[📦 Download for Windows](https://github.com/steveapo/untitled-group-final-project/releases/download/v1.6.2/HotelBooking-v1.6.2.zip)**

### macOS / Linux Setup

```bash
# Extract the archive
tar -xzf HotelBooking-v1.6.2.tar.gz
...
```cmd
# Extract HotelBooking-v1.6.2.zip (right-click → Extract All)
